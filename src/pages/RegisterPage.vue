        ...
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="#" method="POST">
                    ...
                    <ButtonLabel label = 'Sign Up' class= 'w-full' @click="registerUser"/>
                    <p @click="goToLogIn" class="text-sm font-light text-gray-500 dark:text-gray-400">
...
export default {
        ...
        methods: {
            registerUser(){ 
                ...
                const auth = getAuth();
                createUserWithEmailAndPassword(auth, this.user.email, this.user.password).then((data) => {
